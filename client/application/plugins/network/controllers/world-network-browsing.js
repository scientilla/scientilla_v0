...
angular.module("network").controller(
    "worldNetworkReferencesBrowsingController", 
    ["$scope", "worldNetworkReferencesService", "systemStatusService", "$window", "$location", "notificationService", "referencesService",
    function($scope, worldNetworkReferencesService, systemStatusService, $window, $location, notificationService, referencesService) {
        $scope.keywords = "";
        $scope.aReferences = [];
